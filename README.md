...
**Если у вас уже стоит перевод, ознакомьтесь со вторым пунктом Q&A**
...
2. У меня уже стоит мод на кастомный перевод игры / Я использую [менеджер локализации](https://github.com/kimght/LimbusLocalizationManager). Как добавить этот мод к уже существующему?
